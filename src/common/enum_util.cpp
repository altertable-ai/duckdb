...
const StringUtil::EnumStringLiteral *GetLogicalOperatorTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(LogicalOperatorType::LOGICAL_TOP_N_PER_GROUP), "LOGICAL_TOP_N_PER_GROUP" },
...
const StringUtil::EnumStringLiteral *GetPhysicalOperatorTypeValues() {
	static constexpr StringUtil::EnumStringLiteral values[] {
		...
		{ static_cast<uint32_t>(PhysicalOperatorType::STREAMING_TOP_N_PER_GROUP), "STREAMING_TOP_N_PER_GROUP" },
